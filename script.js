...
// Создайте кнопку и абзац в html. Для абзац задайте стили в css файле. При нажатии на кнопку выводите в консоль значение стиля (например, цвет текста) абзаца с использованием getComputedStyle